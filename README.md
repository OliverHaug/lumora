# XYZ — A Social Healing & Coaching Platform

XYZ is a digital platform that connects people on a healing and growth journey with the coaches who fit them best.

Through intelligent matching, personal profiles, and real-time communication, XYZ creates long-term, trust-based coaching relationships instead of random or transactional encounters.
...
XYZ is a Flutter-based platform (mobile + web) that:
...
Beyond matching, XYZ becomes a **social healing ecosystem**.
...
```bash
git clone https://github.com/OliverHaug/xyz.git
cd xyz
flutter pub get
